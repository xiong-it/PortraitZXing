...
public final class AddressBookResultHandler extends ResultHandler {
	...
	public AddressBookResultHandler(Activity activity, ParsedResult result) {
		...
		boolean hasAddress = addresses != null && addresses.length > 0 && addresses[0] != null
				&& !addresses[0].isEmpty();
	...
	public void handleButtonPress(int index) {
		...
		case 0:
			addContact(addressResult.getNames(), addressResult.getNicknames(), addressResult.getPronunciation(),
					...
					addressResult.getEmailTypes(), addressResult.getNote(), addressResult.getInstantMessenger(),
					address1, address1Type, addressResult.getOrg(), addressResult.getTitle(), addressResult.getURLs(),
