...
/**
 * Superclass of implementations which can asynchronously retrieve more
 * information about a barcode scan.
 */
public abstract class SupplementalInfoRetriever extends AsyncTask<Object, Object, Object> {
	...
	private static void executeAsyncTask(AsyncTask task) {
