...
public final class HistoryManager {
	...
	private static final String[] COLUMNS = { DBHelper.TEXT_COL, DBHelper.DISPLAY_COL, DBHelper.FORMAT_COL,
			DBHelper.TIMESTAMP_COL, DBHelper.DETAILS_COL, };
	...
	public void addHistoryItemDetails(String itemID, String itemDetails) {
		...
		try {
			...
			cursor = db.query(DBHelper.TABLE_NAME, ID_DETAIL_COL_PROJECTION, DBHelper.TEXT_COL + "=?",
					new String[] { itemID }, null, null, DBHelper.TIMESTAMP_COL + " DESC", "1");
			String oldID = null;
